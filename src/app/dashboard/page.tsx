...
// Navigation items
const NAV_ITEMS = [
  { id: 'dashboard', label: 'Dashboard', icon: <IconChartLine size={20} /> },
  { id: 'library', label: 'Library', icon: <BookIcon size={20} /> },
  { id: 'study', label: 'Flashcards', icon: <IconPlayCardStar size={20} /> },
  { id: 'speaking', label: 'Speaking Studio', icon: <MicIcon size={20} /> },
  { id: 'planner', label: 'Planner', icon: <CalendarIcon size={20} /> },
    ...
    >
      ...
      <AppShell.Navbar p={0}>
        <Stack h="100%" py={rem(32)} gap={0}>
          {/* Brand */}
          <Group px={rem(24)} mb={rem(48)} gap="sm">
            <Box
              style={{
                width: rem(36),
                height: rem(36),
            ...
            {NAV_ITEMS.map((item) => (
              <UnstyledButton
                ...
                style={{
                  ...
                  color: activeNav === item.id ? 'var(--bb-primary)' : 'var(--bb-on-surface-variant)',
                  backgroundColor: activeNav === item.id ? 'rgba(21, 66, 18, 0.06)' : 'transparent',
                  fontWeight: activeNav === item.id ? 700 : 500,
                  fontSize: rem(15),
                  transition: 'all 0.2s ease',
                  borderRight: activeNav === item.id ? `${rem(3)} solid var(--bb-primary)` : 'none',
                }}
              >
